...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("mydata", "Show your user-scoped memory and conversation details", "Info",
               gateway_only=True),
    CommandDef("memory", "Manage your user-scoped memories", "Tools & Skills",
               gateway_only=True, args_hint="[list|search|add|delete|help]",
               subcommands=("list", "search", "add", "delete", "help")),
    CommandDef("remember", "Save a memory for future conversations", "Tools & Skills",
               gateway_only=True, args_hint="<memory>"),
