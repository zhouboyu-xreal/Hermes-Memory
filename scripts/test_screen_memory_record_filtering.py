...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "tmp" / "screen_memory_record_filtering_test"
DEFAULT_LOG_PATH = DEFAULT_OUTPUT_DIR / "screen_memory_record_filtering_test.log"
DEFAULT_REPORT_PATH = DEFAULT_OUTPUT_DIR / "screen_memory_record_filtering_report.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--db-name",
        default="screen_memory_record_filtering_test.db",
    )
...
def main() -> int:
    ...
    manager_config["screen_fact_generation"]["enabled"] = False
    manager_config["window_workstream_generation"]["enabled"] = False
    manager_config["screen_observation_generation"]["enabled"] = False
    manager_config["task_workstream_generation"]["enabled"] = False
    manager_config["report_block_generation"]["enabled"] = False
